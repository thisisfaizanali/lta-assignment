 ...
 */
import { EPS_MONEY, EPS_PERCENT } from '../rules/constants';
...
// The REASON a band collapsed (rate pinned at ceiling vs. every input
// stated) is authored in engine.ts, in the why string itself — never here.
